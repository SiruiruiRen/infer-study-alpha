...
const translations = {
    en: {
        ...
        video_watch_instructions: "Please read the following instructions carefully: (1) You need to take notes as you watch the video. (2) You will submit your reflection on the video in the next page to complete the assignment. We recommend that you take notes and draft your reflection in a word processor (e.g., Word) as you watch the video, so you can paste it into the text box on the next page.",
    ...
    de: {
        ...
        video_watch_instructions: "Bitte lesen Sie die folgenden Anweisungen sorgfältig: (1) Sie müssen Notizen machen, während Sie das Video ansehen. (2) Sie werden Ihre Reflexion zum Video auf der nächsten Seite einreichen, um die Aufgabe abzuschließen. Wir empfehlen Ihnen, Notizen zu machen und Ihre Reflexion in einem Textverarbeitungsprogramm (z.B. Word) zu verfassen, während Sie das Video ansehen, damit Sie sie in das Textfeld auf der nächsten Seite einfügen können.",
