...
const translations = {
    en: {
        ...
        tutorial_video_description: "This short tutorial will explain how to use the INFER feedback system effectively. Please watch it completely before proceeding.",
        tutorial_watch_instructions: "Click \"Open Tutorial\" to watch the tutorial video. After watching, return here and click \"Continue to Video Task\".",
        open_tutorial: "Open Tutorial",
        continue_after_tutorial: "Continue to Video Task",
    ...
    de: {
        ...
        tutorial_video_description: "Dieses kurze Tutorial erklärt, wie Sie das INFER-Feedbacksystem effektiv nutzen können. Bitte schauen Sie es sich vollständig an, bevor Sie fortfahren.",
        tutorial_watch_instructions: "Klicken Sie auf \"Tutorial öffnen\", um das Tutorial-Video anzusehen. Kehren Sie danach hierher zurück und klicken Sie auf \"Weiter zur Video-Aufgabe\".",
        open_tutorial: "Tutorial öffnen",
        continue_after_tutorial: "Weiter zur Video-Aufgabe",
        tutorial_completed_checkbox: "Ich habe das Tutorial-Video angeschaut",
