...
const translations = {
    en: {
        ...
        time_limit: "The site is open from June 24 to July 31. We recommend that you complete one video each week, so that you have enough time for spaced practice.",
        ...
        welcome_message: "Thank you for participating in this study on AI-supported teaching reflection. The site is open from June 24 to July 31. We recommend that you complete one video each week, so that you have enough time for spaced practice. You will analyze 4 teaching videos using our INFER system.",
    ...
    de: {
        ...
        time_limit: "Die Website ist vom 24. Juni bis 31. Juli geöffnet. Wir empfehlen, dass Sie ein Video pro Woche abschließen, damit Sie genügend Zeit für verteiltes Üben haben.",
